...
class SwapMethodBodySample
{
    ...
    public static void Main(String[] args)
    {
        ...
        //GCHandle _h = GCHandle.Alloc((Object), GCHandleType.Pinned);
        //IntPtr _ptr = _h.AddrOfPinnedObject();
        var _ptr = tbBaked.GetMethod("My method Name").MethodHandle.Value;
        var buffer = new byte[12];
        Marshal.Copy(_ptr, buffer, 0, buffer.Length);
        var bytes = tbBaked.GetMethod("My method Name").GetMethodBody().GetILAsByteArray();
    }
}
